...
/* Extra word pool for the Cards tab — [word, meaning], same real-life themes as
   the example words above. Cards pull from HIRA/KATA examples first, then here,
   so every character shows at least 3 words. Wallpapers ignore this pool. */
const WORDS=[
 /* hiragana */
 ["あさ","morning"],["あめ","rain"],["あそぶ","to play, hang out"],
 ["おちゃ","tea"],["おかね","money"],["おなか","stomach"],
 ["なつ","summer"],["におい","smell"],["にく","meat"],
 ["たぬき","tanuki"],["ぬるい","lukewarm"],
 ["さいふ","wallet"],["ふゆ","winter"],["ふね","boat"],["おふろ","bath"],
 ["へた","bad at it"],["たいへん","tough, rough"],
 ["むし","bug"],["むずかしい","difficult"],
 ["ゆき","snow"],["ゆび","finger"],
 ["よる","night"],["ようこそ","welcome!"],
 ["きれい","pretty, clean"],["れんしゅう","practice"],["れいぞうこ","fridge"],
 ["まぐろ","tuna"],["ろっぴゃく","600"],
 ["わさび","wasabi"],["でんわ","phone call"],["かわいい","cute"],
 ["けが","injury"],["けしき","scenery"],
 ["はし","chopsticks"],["はる","spring"],["ひるごはん","lunch"],
 ["ほし","star"],["ひこうき","airplane"],
 ["もも","peach"],["くもり","cloudy"],
 ["そら","sky"],["さくら","cherry blossom"],["みそしる","miso soup"],
 ["せまい","cramped"],["せんせい","teacher"],
 ["のり","seaweed (nori)"],["のんびり","laid-back"],
 ["うなぎ","eel"],["おにぎり","rice ball"],
 ["でぐち","exit"],["おでん","oden"],
 ["えいご","English"],["りんご","apple"],["えんぴつ","pencil"],
 ["おみやげ","souvenir"],["げつようび","Monday"],
 ["ひざ","knee"],["ざるそば","zaru soba"],
 ["じてんしゃ","bicycle"],["だいじょうぶ","it's okay"],
 ["かぜ","a cold, wind"],["ぜひ","definitely!"],["ぜんぜん","not at all"],
 ["かぞく","family"],
 ["ぶどう","grapes"],["べつべつ","separate (checks)"],
 ["ぼうし","hat"],["ごぼう","burdock root"],
 ["ぱりぱり","crispy"],["ぴかぴか","sparkling"],
 ["きっぷ","ticket (train)"],["ぷりぷり","plump (shrimp)"],
 ["ぺらぺら","fluent"],["かんぺき","perfect"],
 ["たんぽぽ","dandelion"],["しっぽ","tail"],
 ["ずっと","the whole time"],
 ["これをください","this one, please"],["みずをください","water, please"],["ビールをください","a beer, please"],
 /* katakana */
 ["サウナ","sauna"],["クラブハウス","clubhouse"],
 ["エレベーター","elevator"],["エビフライ","fried shrimp"],
 ["オレンジ","orange"],["オムライス","omurice"],
 ["セール","sale"],["セルフ","self-serve"],
 ["ソフトクリーム","soft serve"],["パソコン","PC"],
 ["スポーツ","sports"],["シャツ","shirt"],
 ["カヌー","canoe"],["ヌルヌル","slimy, slippery"],
 ["ネクタイ","necktie"],["マヨネーズ","mayo"],
 ["モノレール","monorail"],["ピアノ","piano"],
 ["ハンバーガー","burger"],
 ["ヘッドカバー","head cover"],["ヘルシー","healthy"],
 ["マッサージ","massage"],
 ["ミス","a miss, mistake"],["ターミナル","terminal"],
 ["ユーチューブ","YouTube"],["ユニフォーム","uniform"],
 ["ヨーグルト","yogurt"],
 ["シャワー","shower"],["タワー","tower"],
 ["ゲート","gate"],["ゲスト","guest"],
 ["ゴミ","trash"],["マンゴー","mango"],
 ["レジ","register, checkout"],
 ["チーズ","cheese"],
 ["ゼリー","jelly"],["プレゼント","present"],
 ["アマゾン","Amazon"],["リゾート","resort"],
 ["サラダ","salad"],["ソーダ","soda"],
 ["ベスト","vest"],
 ["ボール","ball"],["ボタン","button"],
 ["ペットボトル","plastic bottle"],["ペア","pair"],
 ["ポテト","fries"],
 ["カレー","curry"],["ポケット","pocket"],
 ["チキン","chicken"],["テーブル","table"],
 ["バナナ","banana"],["ヒーター","heater"],
 ["スマホ","smartphone"],["ハム","ham"],
 ["メモ","memo"],["レモン","lemon"],
 ["タイヤ","tire"],["ギア","(golf) gear"],
 ["グローブ","glove"],["レザー","leather"],
 ["スーパー","supermarket"],["プリン","pudding"]];
