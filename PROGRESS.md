...
- **HTML app, not terminal.** All drilling happens in `app.html`
  (artifact: https://claude.ai/code/artifact/73a6593e-28e4-4b18-8a1c-8f98bb0d9087 —
  redeploy by re-publishing `app.html` to that same URL). Terminal is only for
  updating this repo. (2026-07-04)
...
- **2026-07-04 (session 1):** Repo + curriculum created. Mid-session pivots:
  ...
  `app.html` trainer (4 roleplay scenes with TTS + self-grade, kana chart/drill
